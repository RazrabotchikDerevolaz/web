...
<head>
  ...
  <link rel="preload" as="style" href="assets/mobirise/css/mbr-additional.css?v=pgVr5m"><link rel="stylesheet" href="assets/mobirise/css/mbr-additional.css?v=pgVr5m" type="text/css">
    ...
    <div class="row justify-content-center mb-4">
      <div class="col-12 col-lg-12">
        <div class="image-wrap">
          <a href="page1.html"><img src="assets/images/logo-fon-youtybe-40962304.png" alt="Mobirise Website Builder"></a>
        </div>
      </div>
    </div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="item features-image col-12 col-md-6 col-lg-4">
				...
				<div class="item-wrapper">
					<div class="item-img">
						<img src="assets/images/mbr.png" alt="Mobirise Website Builder" data-slide-to="1" data-bs-slide-to="2">
					</div>
					<div class="item-content">
						<h5 class="item-title mbr-fonts-style display-5"><strong>Pottery 101</strong></h5>
						...
						<div class="mbr-section-btn item-footer"><a href="index.html#form02-0" class="btn item-btn btn-primary display-7"></a></div>
					</div>
			...
			<div class="item features-image col-12 col-md-6 col-lg-4">
				<div class="item-wrapper">
					<div class="item-img">
						<img src="assets/images/clayton-robbins-ypynhyr7xrs-unsplash-1.jpg" alt="Mobirise Website Builder" data-slide-to="2">
					</div>
					<div class="item-content">
						...
						<p class="mbr-text mbr-fonts-style display-7">
							If you're already familiar with pottery, try to make something more difficult.55555555555555555555555555555555555555555555555555555555555</p>
						<div class="mbr-section-btn item-footer"><a href="index.html#form02-0" class="btn item-btn btn-primary display-7">Enroll now</a></div>
					</div>
				</div>
			</div>
			<div class="item features-image col-12 col-md-6 col-lg-4">
				<div class="item-wrapper">
					<div class="item-img">
						<img src="assets/images/clayton-robbins-kmzrutvsqai-unsplash-1.jpg" alt="Mobirise Website Builder" data-bs-slide-to="3" data-slide-to="3">
					</div>
					<div class="item-content">
						<h5 class="item-title mbr-fonts-style display-5">
		...
		<div class="row content-wrapper justify-content-center">
			<div class="col-lg-7 mbr-form">
				...
				<div class="text-wrapper align-left" data-form-type="formoid">
					<!--Formbuilder Form-->
					<form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="Ly5sm8Rwrgwd7paQK8Gb1rRiyJL955G1nCocucrKB1VAEhhhjORpT3xaC2sOf/zbYeopfJGQ2iobL/Wjafl6MU5KbZaUxYqTXDsjVxmrShlqJ5gdCMJaAMZ+UDZtuwST">
						<div class="row">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="jN2l7OfMtIhaB6mu/xsUzYJtwEXz+96RBFVLPCle2IPThWnzWLa1+H86Wa33Kn7YYiQ/5B2axj9+no+6s0dMqbgao4TH40LVUjCuTj+k9XtnvNA1uJdiPCoOcUoO7w4/">
                    <div class="row">
                        <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Thanks for filling out the form!</div>
                        <div hidden="hidden" data-form-alert-danger="" class="alert alert-danger col-12">
                            Oops...! some problem!
...
<section data-bs-version="5.1" class="social03 cid-vkzmycjsFK" id="social03-0">
...
<section data-bs-version="5.1" class="slider4 mbr-embla cid-vkznQJqFPJ" id="slider04-1">
                            ...
                            <div class="embla__slide slider-image item" style="margin-left: 1rem; margin-right: 1rem;">
                                <div class="slide-content">
                                    <div class="item-img">
                                        ...
                                        <a href="https://razrabotchikderevolaz.github.io/Game-Info/" target="false"></a><a href="https://razrabotchikderevolaz.github.io/Game-Info/index.html"><img src="assets/images/gallery03.jpg" alt="Mobirise Website Builder" title="" data-slide-to="1" data-bs-slide-to="1"></a></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="embla__slide slider-image item" style="margin-left: 1rem; margin-right: 1rem;">
                                <div class="slide-content">
                                    <div class="item-img">
                                        ...
                                        <a href="https://razrabotchikderevolaz.github.io/Game-Info/index.html"><img src="assets/images/gallery03.jpg" alt="Mobirise Website Builder" title="" data-slide-to="2" data-bs-slide-to="2"></a></div>
                                    </div>
                                </div>
                                ...
                                <div class="slide-content">
                                    <div class="item-img">
                                        <div class="item-wrapper">
                                            <img src="assets/images/gallery02.jpg" alt="Mobirise Website Builder" title="" data-slide-to="3" data-bs-slide-to="3">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<section data-bs-version="5.1" class="features25 cid-vkzp8KDZwl" id="features1-2">
...
<section data-bs-version="5.1" class="features11 cid-vkzpjEDfij" id="features11-3">
    <!---->
        ...
        <div class="item features-image">
            <div class="item-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-md-3">
                        <div class="image-wrapper">
                            <a href="index.html#header16-0"><img src="assets/images/product2.jpg" alt="Mobirise Website Builder" title=""></a>
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
...
<section data-bs-version="5.1" class="features9 cid-vkzrxaggSG" xmlns="http://www.w3.org/1999/html" id="features9-5">
        ...
        <div class="item features-image active">
            <div class="item-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <img src="assets/images/product3.jpg" alt="Mobirise Website Builder" data-slide-to="3" data-bs-slide-to="3">
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
                            <div class="row">
                                ...
                                <div class="col-md-auto">
                                    ...
                                    <div class="mbr-section-btn"><a href="https://mobiri.se" class="btn btn-primary display-4">
                                            Buy Now
                                        </a> <a href="https://mobiri.se" class="btn btn-primary display-4">
                                            Buy Now
                                        </a>    <a href="https://mobiri.se" class="btn btn-primary display-4">
                                            Buy Now
                                        </a></div>
            ...
            <div class="item-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <img src="assets/images/product1.jpg" alt="Mobirise Website Builder" data-slide-to="0" data-bs-slide-to="0">
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
        ...
        <div class="item features-image">
            <div class="item-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <img src="assets/images/product2.jpg" alt="Mobirise Website Builder" data-slide-to="1" data-bs-slide-to="1">
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
...
<section data-bs-version="5.1" class="clients1 cid-vkztqHQIM6" id="clients1-7">
...
<section data-bs-version="5.1" class="clients2 cid-vkztr9g6KI" id="clients2-8">
...
<section data-bs-version="5.1" class="gallery5 mbr-gallery cid-vkzttuBk4S" id="gallery5-9">
    ...
    <div class="container">
        ...
        <div class="row mbr-gallery mt-4">
            <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#vl5MAeILks-modal" data-bs-target="#vl5MAeILks-modal">
                    <img class="w-100" src="assets/images/features1.jpg" alt="Mobirise Website Builder" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-vl5MAeILks" data-bs-target="#lb-vl5MAeILks">
            ...
            <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#vl5MAeILks-modal" data-bs-target="#vl5MAeILks-modal">
                    <img class="w-100" src="assets/images/features2.jpg" alt="Mobirise Website Builder" data-slide-to="1" data-bs-slide-to="1" data-target="#lb-vl5MAeILks" data-bs-target="#lb-vl5MAeILks">
                    <div class="icon-wrapper">
                        <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#vl5MAeILks-modal" data-bs-target="#vl5MAeILks-modal">
                    <img class="w-100" src="assets/images/features3.jpg" alt="Mobirise Website Builder" data-slide-to="2" data-bs-slide-to="2" data-target="#lb-vl5MAeILks" data-bs-target="#lb-vl5MAeILks">
                    <div class="icon-wrapper">
                        <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#vl5MAeILks-modal" data-bs-target="#vl5MAeILks-modal">
                    <img class="w-100" src="assets/images/features4.jpg" alt="Mobirise Website Builder" data-slide-to="3" data-bs-slide-to="3" data-target="#lb-vl5MAeILks" data-bs-target="#lb-vl5MAeILks">
                    <div class="icon-wrapper">
                        <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                    </div>
                </div>
        ...
        <div class="modal mbr-slider" tabindex="-1" role="dialog" aria-hidden="true" id="vl5MAeILks-modal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="carousel slide" id="lb-vl5MAeILks" data-interval="5000" data-bs-interval="5000">
                            ...
                            <ol class="carousel-indicators">
                                <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#lb-vl5MAeILks" data-bs-target="#lb-vl5MAeILks"></li>
                                <li data-slide-to="1" data-bs-slide-to="1" data-target="#lb-vl5MAeILks" data-bs-target="#lb-vl5MAeILks"></li>
                                <li data-slide-to="2" data-bs-slide-to="2" data-target="#lb-vl5MAeILks" data-bs-target="#lb-vl5MAeILks"></li>
                                <li data-slide-to="3" data-bs-slide-to="3" data-target="#lb-vl5MAeILks" data-bs-target="#lb-vl5MAeILks"></li>
                            </ol>
                            <a role="button" href="" class="close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Close">
                            </a>
                            <a class="carousel-control-prev carousel-control" role="button" data-slide="prev" data-bs-slide="prev" href="#lb-vl5MAeILks">
                                <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
                                <span class="sr-only visually-hidden">Previous</span>
                            </a>
                            <a class="carousel-control-next carousel-control" role="button" data-slide="next" data-bs-slide="next" href="#lb-vl5MAeILks">
                                <span class="mobi-mbri mobi-mbri-arrow-next" aria-hidden="true"></span>
...
<section data-bs-version="5.1" class="form1 cid-vl56SD1QbC mbr-fullscreen mbr-parallax-background" id="form1-p">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="h6+/Xu9fsYZ52wMkJMWAcB7dju8W9xaxHeyQgslekWc3vwJ0PNtqCGlBMnG6CNB+UIU97xLyUBfwquJloyxH8DeH20q/E3t8PRcnnx5AGf/sLrF5zgjdJKpreMloEMXV">
                    <div class="row">
                        <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Thanks for filling out the form!</div>
                        <div hidden="hidden" data-form-alert-danger="" class="alert alert-danger col-12">
                            Oops...! some problem!
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-md col-12 form-group mb-3" data-for="name">
                            <input type="text" name="name" placeholder="Name" data-form-field="Name" class="form-control" id="name-form1-p">
                        </div>
                        <div class="col-md col-12 form-group mb-3" data-for="email">
                            <input type="email" name="email" placeholder="Email" data-form-field="Email" class="form-control" id="email-form1-p">
                        </div>
...
<section data-bs-version="5.1" class="form3 cid-vl56UI5lCr" id="form3-q">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-7 col-12">
                <div class="image-wrapper">
                    <img class="w-100" src="assets/images/logo-fon-google-40962304.png" alt="Mobirise Website Builder">
                </div>
            </div>
            <div class="col-lg-3 offset-lg-1 mbr-form" data-form-type="formoid">
                <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="0WWGhsDaBt9Uu+jaOm82Kbts/k4PEbavGidcrUD8RAfdrdbNZKevoBqQX2wIbZr7dhpkXbpxiRA44i92FGvKvfnNn9NmpxGpNuUx8wAwOsFFBEc+wmUmDbAUYenayuNj">
                    <div class="row">
                        <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Thanks for filling out the form!</div>
                        <div hidden="hidden" data-form-alert-danger="" class="alert alert-danger col-12">
                            Oops...! some problem!
...
<section data-bs-version="5.1" class="footer5 cid-vl5idX2g6P" once="footers" id="footer5-t">
        ...
        <div class="media-container-row">
            <div class="col-md-2 col-6">
                <div class="media-wrap">
                    <a href="index.html">
                        <img src="assets/images/logo-fon-google-40962304.png" alt="Mobirise Website Builder">
                    </a>
                </div>
            </div>
            <div class="col-10 col-6">
                <p class="mbr-text align-right links mbr-fonts-style display-7">
                    колонтирул&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<a href="#" class="text-black">Term</a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<a href="#" class="text-black">Careers</a> &nbsp;&nbsp;&nbsp;&nbsp;
